...
# Config
# ------------------------------------------------------------------
MODEL_PATH = "model/SE3-PROTACs.pt" # moved to model_loader.py
DEVICE = torch.device("cuda" if torch.cuda.is_available() else "cpu") # moved to model_loader.py

LIGAND_ATOM_TYPE = ['C', 'N', 'O', 'S', 'F', 'Cl', 'Br', 'I', 'P'] 
EDGE_ATTR = {'1': 1, '2': 2, '3': 3, 'ar': 4, 'am': 5} # moved to preprocess.py

# ------------------------------------------------------------------
# SMILES → Graph (moved to preprocess.py)
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# Load model (moved to model_loader.py)
# ------------------------------------------------------------------
def load_model():
...
# ------------------------------------------------------------------
# Read input files (moved to preprocess.py)
# ------------------------------------------------------------------
